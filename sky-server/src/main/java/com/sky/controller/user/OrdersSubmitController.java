...
@Slf4j
public class OrdersSubmitController {
    @Autowired
    ...
    public Result submit(@RequestBody OrdersSubmitDTO ordersSubmitDTO) {
        ...
        OrderSubmitVO orderSubmitVO = ordersSubmitService.submit(ordersSubmitDTO);
    ...
    public Result<PageResult> page(int page, int pageSize, Integer status) {
        PageResult pageResult = ordersSubmitService.pageQuery4User(page, pageSize, status);
    ...
    public Result cancel(@PathVariable("id") Long id) throws Exception {
        ordersSubmitService.userCancelById(id);
    ...
    public Result reminder(@PathVariable("id") Long id) {
        ordersSubmitService.reminder(id);
        return Result.success();
    }
